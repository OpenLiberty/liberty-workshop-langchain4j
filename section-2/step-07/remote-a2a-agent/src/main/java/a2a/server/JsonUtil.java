...
import static a2a.server.A2AErrorCodes.CONTENT_TYPE_NOT_SUPPORTED_ERROR_CODE;
import static a2a.server.A2AErrorCodes.INTERNAL_ERROR_CODE;
import static a2a.server.A2AErrorCodes.INVALID_AGENT_RESPONSE_ERROR_CODE;
import static a2a.server.A2AErrorCodes.INVALID_PARAMS_ERROR_CODE;
import static a2a.server.A2AErrorCodes.INVALID_REQUEST_ERROR_CODE;
import static a2a.server.A2AErrorCodes.JSON_PARSE_ERROR_CODE;
import static a2a.server.A2AErrorCodes.METHOD_NOT_FOUND_ERROR_CODE;
import static a2a.server.A2AErrorCodes.PUSH_NOTIFICATION_NOT_SUPPORTED_ERROR_CODE;
import static a2a.server.A2AErrorCodes.TASK_NOT_CANCELABLE_ERROR_CODE;
import static a2a.server.A2AErrorCodes.TASK_NOT_FOUND_ERROR_CODE;
import static a2a.server.A2AErrorCodes.UNSUPPORTED_OPERATION_ERROR_CODE;
import static a2a.server.JsonUtil.JSONRPCErrorTypeAdapterFactory.THROWABLE_MARKER_FIELD;
