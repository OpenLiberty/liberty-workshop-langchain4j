...
INSERT INTO car_info (id, make, model, year, condition, status)
VALUES (2, 'BMW', 'X5', EXTRACT(YEAR FROM CURRENT_DATE) - 1, 'Recently serviced, excellent condition', 'AT_CLEANING')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO car_info (id, make, model, year, condition, status)
VALUES (8, 'Ford', 'F-150', EXTRACT(YEAR FROM CURRENT_DATE) - 2, 'Small scratch on rear bumper', 'AT_CLEANING')
ON CONFLICT (id) DO NOTHING;
